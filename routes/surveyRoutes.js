const _ = require('lodash'); //helps in iteration and has many helper meathods
const { Path } = require('path-parser'); //extract just the survey id and choice
const { URL } = require('url'); // to get the route
